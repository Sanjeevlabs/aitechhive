  ...
  return (
    <div style={{ padding: "28px 24px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 14 }}>
        <div style={{ width: 34, height: 34, borderRadius: 10, background: "var(--blue-soft)", display: "grid", placeItems: "center" }}>
          <Sparkles size={16} style={{ color: "var(--blue)" }} />
        </div>
        <span style={{ fontSize: 12, fontWeight: 800, color: "var(--blue)", textTransform: "uppercase", letterSpacing: "0.06em" }}>Keep reading free</span>
      </div>
      ...
      <p style={{ margin: "0 0 24px", fontSize: 15, lineHeight: 1.55, color: "var(--text-secondary)" }}>Free. No newsletters. Saves sync across devices.</p>
      ...
      {phase === "sent" ? (
        <div style={{ padding: "18px", borderRadius: 16, background: "var(--green-soft)", border: "1px solid var(--green)", display: "flex", alignItems: "flex-start", gap: 12 }}>
          ...
          <p style={{ margin: 0, fontSize: 15, color: "var(--text-primary)", lineHeight: 1.5 }}>Magic link sent — check your inbox.</p>
        </div>
      ) : (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <button
            onClick={signInGoogle} disabled={phase === "loading"}
            style={{ width: "100%", padding: "14px 16px", borderRadius: 14, background: "var(--card-secondary)", border: "1.5px solid var(--separator)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontSize: 15, fontWeight: 600, color: "var(--text-primary)" }}
          >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 600, color: "var(--text-tertiary)" }}>or email</span>
            <div style={{ flex: 1, height: 1, background: "var(--separator)" }} />
          </div>
          ...
          <button
            ...
            style={{ width: "100%", padding: "14px", borderRadius: 14, background: "var(--blue)", color: "white", fontSize: 15, fontWeight: 700, border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}
          >
      ...
      <div style={{ marginTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <button onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 13, fontWeight: 700, color: "var(--text-secondary)", padding: 0 }}>Skip for now</button>
      </div>
    </div>
  );
}
    ...
    <main style={{
      ...
      <header style={{ flexShrink: 0, padding: "12px 16px 10px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", gap: 7, alignItems: "center" }}>
          ...
          {!user && (
            <button onClick={() => setShowGate(true)} style={{ height: 36, padding: "0 14px", borderRadius: 10, background: "var(--blue)", color: "white", fontSize: 13, fontWeight: 700, border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 5 }}>
