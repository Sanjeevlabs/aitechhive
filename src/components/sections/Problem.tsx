...
export function Problem() {
  return (
    <section className="py-20 px-6 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-32 h-32 blur-3xl animate-float" style={{ backgroundColor: '#D4AF37', opacity: 0.1 }} />
      <div className="absolute bottom-20 left-10 w-32 h-32 blur-3xl animate-float" style={{ backgroundColor: '#D4AF37', opacity: 0.1, animationDelay: '3s' }} />
        ...
        >
          ...
          >
            <div className="glass-card p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 relative overflow-hidden">
              <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(212, 175, 55, 0.05) 0%, rgba(212, 175, 55, 0.02) 50%, rgba(212, 175, 55, 0.05) 100%)' }} />
